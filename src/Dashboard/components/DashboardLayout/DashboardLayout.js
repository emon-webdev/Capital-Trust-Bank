  ...
  return (
    ...
    <div>
      ...
      <div className="flex">
        ...
        <div
          className={`w-[300px] side-bar fixed z-10 top-0 lg:left-0 sm:left-[-100%] duration-500 overflow-y-auto  bg-gradient-to-r from-[#000428] to-[#004E92] shadow h-screen bottom-0 ${
