...
const CreditCardModal = ({ onClose, onOpen, isOpen, overlay, setOverlay }) => {
    ...
    <div className="py-3">
      <Modal isCentered isOpen={isOpen} onClose={onClose}>
        ...
        <ModalContent>
          <ModalHeader>
            {" "}
            <h2 className="py-2 text-xl md:text-4xl font-semibold">
              Apply for Credit Card
            </h2>
          </ModalHeader>
          <ModalBody>
                ...
                <div>
                  ...
                  <div className="mt-2">
                    ...
                    {disable ? (
                      ...
                      <button
                        className="primary-btn sm-btn mt-5 cursor-pointer"
                        type="submit"
                        onClick={onClose}
                      >
                        Apply Now
