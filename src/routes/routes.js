...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      },
      {
        path: "/insurances",
        element: <Insurance />,
        loader: () => fetch("https://capital-trust-bank-server-ten.vercel.app/insuranceData"),
      },
      {
        path: "/insuranceDetails/:id",
        element: <InsuranceDetails />,
        loader: ({ params }) =>
          fetch(`https://capital-trust-bank-server-ten.vercel.app/insur/${params.id}`),
      },
      ...
      // },
      {
        path: "/loansServices",
        element: <Loans />,
        loader: () => fetch("https://capital-trust-bank-server-ten.vercel.app/loanService"),
      },
      {
        path: "/loanDetails/:id",
        element: <LoanDetails />,
        loader: ({ params }) =>
          fetch(`https://capital-trust-bank-server-ten.vercel.app/loanSec/${params.id}`),
      },
      {
        path: "/blogsNews/:id",
        element: <DetailsNews></DetailsNews>,
        loader: ({ params }) =>
          fetch(`https://capital-trust-bank-server-ten.vercel.app/blogsNews/${params.id}`),
      },
      ...
      },
      {
        ...
        element: <TeamDetails />,
        loader: async ({ params }) =>
          fetch(`https://capital-trust-bank-server-ten.vercel.app/team-details/${params.id}`),
      },
      // {
      //   path: "/exchange",
